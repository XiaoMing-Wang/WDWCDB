...
class WDWCDBWrapLoader: NSObject {
   ...
   fileprivate let dbInstance = WDWCDBBaseOperation()
    ...
    @discardableResult
    func insertToDb<T: WDDBStorageProtocol>(object: T, table: String? = nil) -> Bool {
    ...
    //MARK: 插入数据用类名,传表名会使用表名,不传使用tableName()(已经存在会更新)
    @discardableResult
    func insertToDbArray<T: WDDBStorageProtocol>(objects: [T], table: String? = nil) -> Bool {
    ...
    @discardableResult
    func deleteFromDb<T: WDDBStorageProtocol>(ttype: T.Type = T.self, table: String? = nil, where condition: Condition? = nil) -> Bool {
    ...
    //MARK: 删除全部数据
    @discardableResult
    func deleteAllFromDb<T: WDDBStorageProtocol>( ttype: T.Type = T.self, table: String? = nil, where condition: Condition? = nil) -> Bool {
        guard let toTable = table ?? ttype.tableName() else { return false }
    ...
    @discardableResult
    func qureyFromDb<T: WDDBStorageProtocol>( ttype: T.Type,  table: String? = nil,  where condition: Condition? = nil) -> T? {
    ...
    @discardableResult
    func qureyFromDb<T: WDDBStorageProtocol>(
        ttype: T.Type,
        table: String? = nil,
